...
public class SystemKeyspace
{
    ...
    */
    ...
    {
        String req = "UPDATE %s USING TIMESTAMP_FIELD_NAME %d AND TTL %d SET in_progress_ballot = %s WHERE row_key = 0x%s AND cf_id = %s";
    ...
    {
        processInternal(String.format("UPDATE %s USING TIMESTAMP_FIELD_NAME %d AND TTL %d SET proposal_ballot = %s, proposal = 0x%s WHERE row_key = 0x%s AND cf_id = %s",
                                      PAXOS_CF,
    ...
    public static void savePaxosCommit(Commit commit)
    {
        ...
        String cql = "UPDATE %s USING TIMESTAMP_FIELD_NAME %d AND TTL %d SET proposal_ballot = null, proposal = null, most_recent_commit_at = %s, most_recent_commit = 0x%s WHERE row_key = 0x%s AND cf_id = %s";
