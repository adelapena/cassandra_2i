...
public final class CFMetaData
{
    ...
    private static boolean isDense(AbstractType<?> comparator, Collection<ColumnDefinition> defs)
    {
         ...
         * CLUSTERING_KEY_FIELD_NAME ColumnDefinitions is equal to comparator.componentsCount() - 1 or not.
         *
         * But non-upgraded thrift CF will have no such CLUSTERING_KEY_FIELD_NAME column definitions, so we need
         ...
         * sure if a CF without REGULAR columns nor CLUSTERING_KEY_FIELD_NAME definition is meant to be dense, or if it
